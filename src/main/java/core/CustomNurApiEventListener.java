...
/**
 * This class implements all event-driven callbacks of the NurApi provided by {@link NurApiListener}
 * It has no interactive operations - primarily logging happens here.
 */
@Slf4j
public class CustomNurApiEventListener implements NurApiListener {
    @Override
